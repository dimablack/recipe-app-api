...
def create_user(email='user@example.com', password='tes_pass_123'):
...
class PrivateTagsApiTest(TestCase):
    ...
    def test_retrieve_tags(self):
        ...
        Tag.objects.create(user=self.user, name='Grass')
    ...
    def test_update_tag(self):
        """Test updating a tag."""
        tag = Tag.objects.create(user=self.user, name='new Food')

        payload = {'name': 'Another food'}
